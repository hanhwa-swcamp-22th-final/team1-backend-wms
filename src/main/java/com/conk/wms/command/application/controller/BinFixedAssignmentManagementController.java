...
public class BinFixedAssignmentManagementController {
    ...
    public ResponseEntity<BinFixedAssignmentResponse> createAssignment(
        ...
        return ResponseEntity.ok(manageBinFixedAssignmentService.create(resolveTenantId(authContext), request));
    }
    ...
    public ResponseEntity<BinFixedAssignmentResponse> updateAssignment(
        ...
        return ResponseEntity.ok(manageBinFixedAssignmentService.update(resolveTenantId(authContext), binId, request));
    }
}
