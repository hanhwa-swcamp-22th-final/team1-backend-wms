...
public class WhInventoryQueryController {
    ...
    public ResponseEntity<List<WhInventoryItemResponse>> getInventories(
        ...
        return ResponseEntity.ok(getWhInventoriesService.getInventories(resolveTenantId(authContext)));
    }
    ...
    public ResponseEntity<WhInventoryItemResponse> getInventory(
        ...
        return ResponseEntity.ok(getWhInventoriesService.getInventory(resolveTenantId(authContext), inventoryId));
    }
}
