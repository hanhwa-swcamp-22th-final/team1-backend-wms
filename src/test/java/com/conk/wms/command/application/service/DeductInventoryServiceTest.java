...
class DeductInventoryServiceTest {
    ...
    void deduct_success() {
        ...
        when(inventoryRepository.findAvailableByLocationIdAndSku("LOC-001", "SKU-001")).thenReturn(Optional.of(mockInventory));
    ...
    void deduct_whenInventoryNotFound_thenThrow() {
        // given
        when(inventoryRepository.findAvailableByLocationIdAndSku("LOC-999", "SKU-001")).thenReturn(Optional.empty());
